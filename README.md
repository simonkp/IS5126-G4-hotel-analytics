...
**Assignment:** Group Assignment (Assignment 1: Data Foundation & Exploratory Analytics; Assignment 2: Production & Advanced Analytics)  
**Business context:** HospitalityTech Solutions – analytics platform for hotel managers (satisfaction drivers, improvement opportunities, benchmarking, trends, resource allocation).
...
## Data requirements (Assignment 1)
...
- Python 3.10 (or 3.8+ per assignment)
...
### 2. Sample DB (5,000+ reviews for TAs)
...
## Assignment 1 deliverables checklist (per assignment PDF)
...
- Choose 3 of 4 problems (Predictive, Text Intelligence, Intelligent Automation, Knowledge Graphs).
- Add notebooks 05–09, models/, api/, tests/ as needed.
- Update streamlit_app.py and reports/assignment2_report.pdf.
